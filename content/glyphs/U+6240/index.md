...
| Shang<br>(Shi) | Shang<br>(Bin) | Shang<br>(Wuming) | Late<br>W.Zhou | Chunqiu<br>(Qin) | Qin | W.Han | E.Han | Nanbei<br>(N.Wei) | Tang |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
...
Depiction of hitting a scapula ({{<ref "⿻𠃌𠃊">}}) with an axe ({{<ref "斤">}}).
