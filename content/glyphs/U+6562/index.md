...
| Shang<br>(Bin) | Shang<br>(Bin) | Shang<br>(Wuming) | Early<br>W.Zhou | Early<br>W.Zhou | Middle<br>W.Zhou | Zhanguo<br>(Qin) | Qin | Qin | E.Han | E.Han | Nanbei<br>(N.Wei) |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
...
Depiction of a pig ({{<ref "豕">}}) being catched by a net ({{<ref "𰅱">}}) in a hand ({{<ref "又">}}).
