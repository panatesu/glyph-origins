...
| Shang<br>(Bin) | Shang<br>(Bin) | Shang<br>(Bin) | Middle<br>W.Zhou | Chunqiu<br>(Qin) | Zhanguo<br>(Qin) | Qin | Qin | Qin | W.Han | E.Han | Nanbei<br>(N.Wei) |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
...
Either depiction of a foot ({{<ref "止">}}) going from a starting point or ♪{{<ref "止">}}
