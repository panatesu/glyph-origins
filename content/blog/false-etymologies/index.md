...
Etymology is a science and it must utilize scientific methods, eschewing any guesswork, fantasies and other ‘temptations’. The origin of every character ***must*** be supported by evidence based on ***academic methodology***.
...
- The study of inscriptions on bronze vessels (in a broad sense, all inscriptions from Shang to Han; in a narrow sense, only Western Zhou inscriptions)
...
With the fall of the Qin Empire and the transition to the Han era, the pressure on Confucianism lessened and the texts, which had been transmitted mostly orally until then, were again written down, this time using the clerical script that was popular at the time.
...
In reality, Chinese characters are way more diverse than these six categories imply and the divisions between the various types are often not very clear at all. But three main categories could be singled out: semantograms, rebuses (sound loans) and phonograms compounds. They can also be divided into smaller subtypes.
...
Phonograms are compound characters that contain a phonetic element (a phonetic).
...
Sometimes you can find a character made up of two identical phonetic elements. You could say they’re phonograms, except they lack a semantic. These kinds of characters shouldn’t be confused with the likes of 在, which have a phonetic added to a sound loan but use it as a semantic too. This category of characters is peculiar to early writing. Some notable ones are 友 ‘friend’ (two 又), 比 ‘to compare’ (two 匕), 兩 (two 丙). These characters use the repetition of the phonetic to convey the idea of a pair.

Some compounds, in which the semantic has been replaced, can be considered a separate category. For example, you can say that 賑 ‘to donate’ is derived from 振 ‘to help’ with the semantic replaced to 貝 ‘sea shell (cowry)’. Of course, you can also say that these are regular phonograms.

A more modern and unique category are the fanqie type derivations. This is when the initial consonant of the syllable is taken from one element, while the rest of the syllable is taken from the other element. These characters were created for the more precise transcription of foreign sounds that Chinese didn’t have. Some examples are the characters 𡅖 (the initial of 名 + the final of 養) and 𠆙 (the initial of 亭 + the final of 夜) from Buddhist texts.
...
- Different approaches to character construction (the phonogram 体 ‘pallbearer’ and the compound semantogram 体 ‘body’)
...
Now that we’ve got the bare basics down, let’s move on to the question set up in the title of the article. Here we’ll cover the key aspects that you’ll need to understand and internalize to be able to tell whether the character etymology presented to you is trustworthy.

### 1. More than 90% of Characters are Phonograms

This is the most basic rule that you have to keep in mind. Since most characters are phonograms, the first thing that you should do is look for the phonetic. Let’s take this (wrong) etymology for instance:
...
Another case when the phonetics can be considered to bear semantic load is when a semantic gets attached to a character without a change in meaning. We’ve discussed this device extensively in the part dedicated to phonograms.
...
Every etymology must be proven. To prove them, an entire arsenal of materials must be utilized:
...
Here we’ve used linguistic data, ancient dictionaries, ancient and received texts and the general tendencies of early writing (sound loans, corruption, the frequency of phonograms, etc.) to prove our thesis.
...
Then why does the phonetic not align with the reading? The answer is actually pretty simple, the reading changed under the influence of a different word ‘to open’, specifically {⁠闓⁠} \*kʰˤəiʔ. This probably happened back in around the 3rd century BC. This kind of sleight of hand is important to keep in mind.
...
You should be wary of some authors, like Wang Ning (王寧), who is not a palaeographer. Her etymologies are frequently criticized by leading scholars. What’s more is that she has an unhealthy reliance on the Shuowen. Another example of a scholar you should avoid is Shizuka Shirakawa. They worship him over in Japan, they show him on TV, constantly cite, but his etymologies are either painfully outdated or based on thin air.
...
### Shang Era (+ Oracle Bones)

劉釗《新甲骨文編》(2014) (the most trustworthy dictionary for now)

黃德寬《商代文字字形表》(2017) (a good review dictionary of Shang forms including bronze/jade/brush/etc. inscriptions)

畢秀潔《商代文全編》(2012) (a nice compilation of characters from the Shang bronzes)

松丸道雄《甲骨文字字釋綜覽》(1994) (a huge overview of interpretations of oracle bone characters from the last century)

趙偉《殷墟甲骨語詞彙釋》(2018) (a huge dictionary of character meanings and usages)

于省《甲骨文字詁林》(1996) (a classic summary of forms and meanings, but obviously outdated)

何景成《甲骨文字詁林補編》(2017) (many corrections and additions to the previous one based on new researches)
...
[cnki.net](http://cnki.net/) (the obvious and best candidate, but requires a university subscription if you don’t want to pay to download articles)

[jgw.aynu.edu.cn](http://jgw.aynu.edu.cn/) (a huge number of articles, dissertations, etc, periodically uploading new stuff, but the site does not work from 3PM to 8PM UTC)

[resource.hzlib.cn](http://resource.hzlib.cn/) (a huge collection of articles from various journals, not limited to just palaeography)

[fdgwz.org.cn](http://fdgwz.org.cn/) (some articles)

[xianqin.org](http://xianqin.org/) (some notes and thingies)

[bsm.org.cn](http://bsm.org.cn/) (for bamboo and silk writing)

### Useful Online Compilations and Dictionaries

[kaom.net](http://kaom.net/) (a Chinese studies student’s bible, very handy for reconstructions,sound loans, huge dialect databases, etc)

[zi.tools](http://zi.tools/) (an excellent site on character meanings and ancient forms (which you should always against the latest scholarship), which is constantly updated with various features and other things, which you can follow on their telegram channel)

[jgw.aynu.edu.cn](http://jgw.aynu.edu.cn/) (already featured above, but it’s also a huge corpus of bone inscriptions)

[bsm.org.cn](http://bsm.org.cn/) (also featured above, and can also be used as a bamboo inscription corpus)

[coe21.zinbun.kyoto-u.ac.jp](http://coe21.zinbun.kyoto-u.ac.jp/) (huge corpus of inscriptions on stelae and forms that can be found on them)

[mokkanko.nabunken.go.jp](http://mokkanko.nabunken.go.jp/) (corpus of Japanese mokkans)

[wcd-ihp.ascdc.sinica.edu.tw/woodslip](http://wcd-ihp.ascdc.sinica.edu.tw/woodslip) (corpus of Han zhujian inscriptions)

[mojiportal.nabunken.go.jp](http://mojiportal.nabunken.go.jp/) (here you can quickly look up the forms of the character in Japanese mokkan and zhujian inscriptions + some other stuff, but it’s generally better to use corpora for that)

[idp.bl.uk](http://idp.bl.uk/) (Dunhuang collections)

[codh.rois.ac.jp/tensho](http://codh.rois.ac.jp/tensho) (collections of seal forms, including many transmitted ancient forms and forms from the Shuowen)

[base1.nijl.ac.jp](http://base1.nijl.ac.jp/) (a compilation of Japanese seals)

[dict.variants.moe.edu.tw](http://dict.variants.moe.edu.tw/) (a dictionary of variants of characters with scans of their sources)

[database-of-medieval-chinese-texts.be](http://database-of-medieval-chinese-texts.be/) (huge compilation of forms from Dunhuang manuscripts)
